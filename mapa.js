...
const TERRITORIOS = {
  ...
  "Sumorsaete": { regiao: "Westseaxe", litoral: true, vizinhos: ["Defnas", "Wintanceaster", "Gleawanceaster", "Tomtun", "Hereford", "Gwent"] },
  "Gleawanceaster": { regiao: "Westseaxe", litoral: false, vizinhos: ["Tomtun", "Wintanceaster", "Lundenburg", "Sumorsaete", "Hamtun"] },
  "Wintanceaster": { regiao: "Westseaxe", litoral: true, vizinhos: ["Sumorsaete", "Gleawanceaster", "Suthseaxe", "Lundenburg"] },
  ...
  "Lundenburg": { regiao: "Westseaxe", litoral: false, vizinhos: ["Cent", "Eastseaxe", "Suthseaxe", "Gleawanceaster", "Hamtun", "Grantebrycge", "Wintanceaster"] },
  ...
  "Grantebrycge": { regiao: "East Engle", litoral: false, vizinhos: ["Eastseaxe", "Suthfolc", "Northfolc", "Medeshamstede", "Hamtun", "Lundenburg"] },
  "Medeshamstede": { regiao: "East Engle", litoral: true, vizinhos: ["Lindcylene", "Ligeraceaster", "Grantebrycge", "Hamtun", "Snotingaham", "Northfolc"] },
  "Hamtun": { regiao: "Mierce", litoral: false, vizinhos: ["Lundenburg", "Grantebrycge", "Medeshamstede", "Ligeraceaster", "Tomtun", "Gleawanceaster"] },
  ...
  "Legaceaster": { regiao: "Mierce", litoral: false, vizinhos: ["Hereford", "Gwynedd", "Northworthig", "Doneceaster", "Rippel", "Mameceaster", "Powys"] },
  ...
  "Powys": { regiao: "Cymru", litoral: true, vizinhos: ["Gwynedd", "Dyfed", "Gwent", "Hereford", "Legaceaster"] },
  "Dyfed": { regiao: "Cymru", litoral: true, vizinhos: ["Powys", "Gwent"] },
  "Gwent": { regiao: "Cymru", litoral: true, vizinhos: ["Hereford", "Powys", "Dyfed", "Sumorsaete"] },
  "Rippel": { regiao: "Northhymbre", litoral: true, vizinhos: ["Legaceaster", "Mameceaster", "Streoneshalh", "Loncaster"] },
  ...
  "Loncaster": { regiao: "Northhymbre", litoral: false, vizinhos: ["Streoneshalh", "Hagustaldesham", "Mailros", "Hwiterne", "Rippel"] },
  ...
  "Ard Sratha": { regiao: "Dál Riata", litoral: false, vizinhos: ["Daire", "Ráth Bhoth", "Droim Chliabh", "Cruachan", "Beannchar", "Mainistir Bhuithe"] },
  ...
  "Mainistir Bhuithe": { regiao: "Ériu", litoral: true, vizinhos: ["Dyflin", "Cruachan", "Beannchar", "Ard Sratha"] },
