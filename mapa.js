...
const TERRITORIOS = {
  ...
  "Snotingaham": { regiao: "Mierce", litoral: false, vizinhos: ["Mameceaster", "Beoferlic", "Lindcylene", "Medeshamstede", "Ligeraceaster", "Doneceaster", "Northworthig"] },
  "Lindcylene": { regiao: "Mierce", litoral: true, vizinhos: ["Beoferlic", "Medeshamstede", "Snotingaham"] },
  ...
  "Mameceaster": { regiao: "Northhymbre", litoral: false, vizinhos: ["Doneceaster", "Legaceaster", "Snotingaham", "Rippel", "Streoneshalh", "Beoferlic"] },
  "Beoferlic": { regiao: "Northhymbre", litoral: true, vizinhos: ["Lindcylene", "Snotingaham", "Mameceaster", "Streoneshalh"] },
  "Streoneshalh": { regiao: "Northhymbre", litoral: true, vizinhos: ["Bebbanburg", "Rippel", "Loncaster", "Mameceaster", "Beoferlic", "Hagustaldesham"] },
...
const REGIOES = {
  ...
  "Northhymbre": { bonus: 5, territorios: ["Rippel", "Mameceaster", "Beoferlic", "Streoneshalh", "Bebbanburg", "Hagustaldesham", "Din Eidyn", "Loncaster", "Mailros"] },
