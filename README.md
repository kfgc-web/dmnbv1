...
- **Grande Exército:** os vikings invadem e cada reino é um jogador (9 lugares). Os vikings querem 4 regiões; os reinos querem expulsá-los.
...
- **Great Army:** the Vikings invade and every kingdom is a player (9 seats). The Vikings want 4 regions; the kingdoms want them gone.
